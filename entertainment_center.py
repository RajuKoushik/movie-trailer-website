...
def personalised_movies_list():
    ...
    pursuit_of_happiness = media.Movie(title='Pursuit of Happiness', trailer_youtube_url='https://www.youtube.com/watch?v=89Kq8SDyvfg', # noqa
    ...
    wolf_of_wallstreet = media.Movie(title='Wolf of Wallstreet', trailer_youtube_url='https://www.youtube.com/watch?v=iszwuX1AK6A', # noqa
